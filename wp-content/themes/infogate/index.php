...
<div>
	...
	<div class="destacados" >
		...
		<!-- EndPalacio4 -->
		<!-- Elecciones -->
		<?php query_posts('cat=4961&showposts=1'); ?>
		<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
   	...
   	<div class="ad ads-234 ">
		...
		<!--<div style="width: 100%; height:20px;background-color: #0082ac; color:white;font-weight: bold; text-align: center;font-size: 1.20em;"> </div>
-->
					<div class="turismon">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
						<a href="http://www.infogate.cl/category/turismo-nacional/"><div class="menu-turismo">Animales&Mascotas</div></a>
						<!--<div class="cats"><?php exclude_post_categories("4, 7"); ?></div>-->
						
						<?php $thumb_id = get_post_thumbnail_id(); $thumb_url = wp_get_attachment_image_src($thumb_id,'home-1', true); ?>
						<a href="<?php the_permalink() ?>"><img class="img" src="<?php echo $thumb_url[0]; ?>" alt="<?php the_title(); ?>" /></a>
						
						<div style="margin-left:5px; margin-right:2px;" class="turismo-title"><h2><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h2>
				...
				<div class="turismoi">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
				<a href="http://www.infogate.cl/category/tendencias/"><div class="menu-turismo">Tendencias</div></a>
						<!--<div class="cats"><?php exclude_post_categories("4, 7"); ?></div>-->
				...
				<div class="ocio">
						...
						<?php query_posts('cat=6892&showposts=1'); ?>
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
	
						<article <?php post_class() ?> id="post-<?php the_ID(); ?>">
				<a href="http://www.infogate.cl/category/cultura-y-espectaculos/"><div class="menu-turismo">Cultura&Espectáculos</div></a>
						<!--<div class="cats"><?php exclude_post_categories("4, 7"); ?></div>-->
...
<?php query_posts('cat=4961&showposts=3'); ?>
		...
		<?php wp_reset_query(); ?>
	   				...
	   				<center>
					<!-- /124506296/N_NOTICIAS_Infogate.cl/Infogate_728x90 -->

					<div id='div-gpt-ad-1448304889500-9' style='height:90px; width:728px;'>

					<script type='text/javascript'>

					googletag.cmd.push(function() { googletag.display('div-gpt-ad-1448304889500-9'); });
		...
		<div class="destacados">
			...
			<!--Mascotas-->
			<?php query_posts('cat=6342&showposts=1'); ?>
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
